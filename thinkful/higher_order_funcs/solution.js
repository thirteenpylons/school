...
To complete this practice problem, you will write the functions according 
to the functions below. All of your functions should make use of the forEach() method.

This practice problem should take no more than 20 minutes. 
...
Write a function logTreeTypethat uses forEach to log the type of 
each tree object to the console.
...
Write a function buildSentence that takes in an array of words and uses 
forEach to add the strings together. It should also add 
...
Write a function logPercentages that takes an array of decimal numbers 
and uses forEach to log each one with some formatting as shown below.
