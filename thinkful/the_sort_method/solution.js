...
function sortNumbers(numbers) {
    return numbers.sort((firstNumber, secondNumber) => firstNumber - secondNumber);
}

function largestFirst(numbers) {
    return numbers.sort((firstNumber, secondNumber) => secondNumber - firstNumber);
}

function sortFlowersByZone(flowers) {
    return flowers.sort((firstFlower, secondFlower) => firstFlower.zone - secondFlower.zone);
}

function sortByLength(strings) {
    return strings.sort((firstString, secondString) => firstString.length - secondString.length);
}
